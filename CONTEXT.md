...
- **▶ 下一刀：** `automation-skipped-streak-drilldown`：把连续 skipped 告警变成可直接展开的 20 条窗口原因组，明确 `≥20` 截断，保留普通记录与 pending 的恢复路径。调研见 `app/.progress/automation-next-gap-discovery-2026-08-19.md`。G8-4b 仍禁开。
