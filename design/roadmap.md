...
| 17 | **第八波（后端精细度）：G6-1 → G6-2 → G6-3** | G6 | G6-1 ✅（[closeout](app/.progress/g6-1-priority-scheduling-closeout-2026-08-03.md)）· G6-2 ✅（2026-08-03，[closeout](app/.progress/g6-2-automation-placeholder-closeout-2026-08-03.md)，全量 1495 用例绿）→ 下一刀 G6-3 测试补网；G6-4 起按 §3 价值取用 |
