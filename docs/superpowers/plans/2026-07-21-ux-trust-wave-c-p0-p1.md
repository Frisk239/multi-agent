...
- [x] Step 1: ThinkingRow 稳定展示 progress + 最近 tool 名
- [x] Step 2: 可选 partial assistant 行（WS + run-messages 轮询）
- [x] Step 3: `web/scripts/test-chat-live-d1.mts` 规则门禁 ALL PASS
- [x] Step 4: progress 文档
