...
- **▶ 下一刀默认（roadmap §4）：** **G5-5 系统/桌面通知**（run 终态/inbox 新项）或 **G4-5 余项（health 一键报告 / backlink 相关页）**。已关（08-02）：第一波 G3-1/G1-1/G2-1/G1-2/G4-1/G4-2 · M1：G1-3 · G2-2 · G4-3 · M2：G1-4 · G2-3 · G3-2 · M3：G2-4 · G4-4 · **第三波（Goal 产品完成态）**：G5-1 scanner/import-url 测试（含 2 生产 bug 修复）· G5-2 auto-retry 类型安全化 · G5-3 灾备 Wiki 换入 · G5-4 进程生命周期收尾 · G3-3 行内 transcript 预览 · G3-4 envVars/customArgs 编辑 · G3-5 附件真实上传 · G4-5 `ma wiki query --roots`（closeout 全部见 [goal3-wave-closeout](app/.progress/goal3-wave-closeout-2026-08-02.md)）· **第四波（运营闭环+最终打磨）M1**：G3-4b 执行层注入闭环（envVars/customArgs spawn 生效，[closeout](app/.progress/g34b-env-inject-closeout-2026-08-02.md)；printenv 实证 grok run completed 报告值一致）
