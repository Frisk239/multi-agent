...
- **已交（近）：** UX Trust A–D · Day-0 · P2 · **DS2 手动排序** · **DS4 token/thinking** · **DS1 session resume（claude MVP）**
- **▶ 阶段计划：** [phase-ux-deep-2026-07-22.md](app/.progress/phase-ux-deep-2026-07-22.md)  
  ...
  · **DS2 ✅ · DS4 ✅ · DS1 ✅** → 下一刀默认 **DS3 Wiki per-project**（必 ADR）  
  · 非目标：云账单 · daemon 多机 · 密钥入库 · 跨 runtime 迁 session
- **上一刀 intake：** [ds4-token-thinking-intake.md](app/.progress/ds4-token-thinking-intake.md)（通过）；DS1 closeout 见 `ds1-session-resume-impl-1.md` · ADR [0004](docs/adr/0004-cli-session-resume.md)
