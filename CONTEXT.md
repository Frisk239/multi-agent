...
- **▶ 下一刀默认（roadmap §4）：** **G1-2 Grok ACP/fail-closed**（产品误导项，诚实性优先）→ G4-1 记忆检索 FTS5。已关：**G3-1 错误态三件套**（[closeout](app/.progress/g3-1-error-states-closeout-2026-08-02.md)）· **G1-1 Pi 真机验收 + RPC 命令面**（[closeout](app/.progress/g1-1-pi-real-closeout-2026-08-02.md)）· **G2-1 Deferred-escalation**（[closeout](app/.progress/g2-1-deferred-escalation-closeout-2026-08-02.md)）。
