...
- **▶ 下一刀默认（roadmap §4，Goal 第二波 M3）：** **G2-4 读投影残留清理** → G4-4 Memory scope 多维精化 → M4：G5-1 skill/scanner 测试 → G5-2 auto-retry 类型安全化。已关（08-02）：第一波 G3-1/G1-1/G2-1/G1-2/G4-1/G4-2（closeout 见 roadmap §4）· **M1**：G1-3 探测宽限窗 · G2-2 Autopilot 离线语义 · G4-3 Wiki ingest 无 key 直接 dead（[g1-3](app/.progress/g1-3-probe-grace-closeout-2026-08-02.md) · [g2-2](app/.progress/g2-2-autopilot-offline-closeout-2026-08-02.md) · [g4-3](app/.progress/g4-3-wiki-nokey-honest-closeout-2026-08-02.md)）· **M2**：G1-4 失败分类中文边界 + UI 文案 · G2-3 子代理成本折叠 · G3-2 看板键盘拖拽（[g1-4](app/.progress/g1-4-failure-classify-closeout-2026-08-02.md) · [g2-3](app/.progress/g2-3-cost-rollup-closeout-2026-08-02.md) · [g3-2](app/.progress/g3-2-kanban-keyboard-closeout-2026-08-02.md)）
