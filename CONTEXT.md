...
- **▶ 下一刀默认（roadmap §4，Goal 第二波 M2）：** **G1-4 失败分类精度** → G2-3 子代理成本汇总 → G3-2 看板键盘可达。已关：**G3-1** · **G1-1** · **G2-1** · **G1-2** · **G4-1 记忆检索 FTS5** · **G4-2 流式围栏 scrubber**（[closeout](app/.progress/g4-2-stream-scrubber-closeout-2026-08-02.md)）· **M1 三刀（08-02）**：G1-3 探测宽限窗单测+真实 runtime 回归 · G2-2 Autopilot 离线语义（run_only 离线→skipped / create_issue 离线仍建卡）· G4-3 Wiki ingest 无 key 直接 dead 不烧退避（[G1-3](app/.progress/g1-3-probe-grace-closeout-2026-08-02.md) · [G2-2](app/.progress/g2-2-autopilot-offline-closeout-2026-08-02.md) · [G4-3](app/.progress/g4-3-wiki-nokey-honest-closeout-2026-08-02.md)）
