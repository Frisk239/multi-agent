...
- **▶ 下一刀默认（roadmap §4）：** **G1-3 CLI 探测失败宽限窗** → G3-2 看板键盘可达 → G4-3 Wiki ingest 无 key 降级诚实化。已关：**G3-1** · **G1-1** · **G2-1** · **G1-2** · **G4-1 记忆检索 FTS5** · **G4-2 流式围栏 scrubber**（[closeout](app/.progress/g4-2-stream-scrubber-closeout-2026-08-02.md)；注入→回显→剥离全链路真机验证）。
