...
| 17 | **第八波（后端精细度）：G6-1 → G6-2 → G6-3** | G6 | G6-1 ✅（[closeout](app/.progress/g6-1-priority-scheduling-closeout-2026-08-03.md)）· G6-2 ✅（[closeout](app/.progress/g6-2-automation-placeholder-closeout-2026-08-03.md)）· **G6-3 ✅（2026-08-03，[closeout](app/.progress/g6-3-test-net-closeout-2026-08-03.md)，全量 1516 用例绿）** → 此后按 §3 价值取用（G6-4 sweeper 原子化 / G6-6 pi 诚实提示 / G6-7 skipped 警示） |
